...
const TermsPage = () => {
    return (
        <div className={styles.liner}>
            ...
            <div className={styles.termsLiner}>
                <div className={styles.termsSection}>
                    ...
                    <div className={styles.termsDescriptionSection}>
                        <div className={styles.termsDescription}>
                            These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;) and Bluprint, doing business as Bluprint(&quot;Bluprint&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), concerning your access to and use of the https://trybluprint.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the &quot;Site&quot;). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions or documents that may be posted on the Site from time to time are hereby expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make changes or modifications to these Terms of Use at any time and for any reason. We will alert you about any changes by updating the &quot;Last updated&quot; date of these Terms of Use, and you waive any right to receive specific notice of each such change. It is your responsibility to periodically review these Terms of Use to stay informed of updates. You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes in any revised Terms of Use by your continued use of the Site after the date such revised Terms of Use are posted.
                        </div>
                        <div className={styles.termsDescription}>
                ...
                <div className={styles.termsSection}>
                    ...
                    <div className={styles.termsDescriptionSection}>
                        <div className={styles.termsDescription}>
                            ...
                            24. Use the Site as part of any effort to compete with us or otherwise use the Site and/or the Content for any revenue-generating endeavor or commercial enterprise.                        </div>
                    </div>
                </div>
                <div className={styles.termsSection}>
                    <div className={styles.termsTitle}>
                ...
                <div className={styles.termsSection}>
                    ...
                    <div className={styles.termsDescriptionSection}>
                        <div className={styles.termsDescription}>
                            Bluprint may change the materials contained on its Website at any time without notice. Bluprint does not make any commitment to update the materials. We may revise these Terms of Use for its Website at any time without prior notice. By using this Website, you are agreeing to be bound by the current version of these Terms and Conditions of Use
                        </div>
                    </div>
                </div>
                <div className={styles.termsSection}>
                    ...
                    <div className={styles.termsDescriptionSection}>
                        <div className={styles.termsDescription}>
                            Bluprint will not be hold accountable for any damages that will arise with the use or inability to use the materials on Bluprint&apos;s Website, even if Bluprint or an authorize representative of this Website has been notified, orally or written, of the possibility of such damage. Some jurisdiction does not allow limitations on implied warranties or limitations of liability for incidental damages, these limitations may not apply to you.
                        </div>
                    </div>
                </div>
                <div className={styles.termsSection}>
                ...
                <div className={styles.termsSection}>
                    ...
                    <div className={styles.termsDescriptionSection}>
                        <div className={styles.termsDescription}>
                            Any claim related to Bluprint&apos;s Website shall be governed by the laws of us without regards to its conflict of law provisions.
                        </div>
                    </div>
                </div>
            </div>
